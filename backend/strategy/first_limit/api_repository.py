    ...
    *,
    ...
    rows = connection.execute(
        f"""SELECT
              ...
              m.security_name,
              s.sw_level2_code industry_level2,s.sw_level3_code industry_level3,
              s.effective_industry_level,s.effective_industry_code,
              s.effective_score intraday_industry_score,s.effective_rank intraday_industry_rank,
              s.official_industry_score,s.official_industry_rank,
              s.capital_activity_score,s.leader_score,
              s.intraday_total_score,s.intraday_candidate_grade,
              s.final_total_score,s.final_candidate_grade,s.final_buy_recommendation,
              s.confirmation_status,s.confirmation_change_type,s.industry_context_status,
              r.data_cutoff,s.confirmed_at,
