...
def test_price_and_latest_dps_always_produce_latest_yield():
 ...
 CREATE TABLE annual_cash_dividend_summaries(market text,symbol text,calendar_year integer,cash_dividend_per_share real,current_basis_dps real);
 ...
 INSERT INTO annual_cash_dividend_summaries VALUES('CN','600001.SH',2023,1,.5),('CN','600001.SH',2024,2,1),('CN','600001.SH',2025,3,3);
 ...
 assert row['three_year_average_yield']==.15
 assert row['conservative_three_year_current_yield']==.05
